...
<?php
    ...
    $navigation = '
            ...
            <ul class="nav-child">
                <a href="ejercicio10.php" class="nav-link">Ejercicio 10</a>
            </ul>
            <ul class="nav-child">
    ...
    foreach($imagenes as $imagen){
        crearPagina($imagen, pathinfo($imagen)['filename']);
        echo '<a href="'. mostrarDireccion(pathinfo($imagen)['filename']) . '">' . basename($imagen) . '</a></br>';
    }
    ...
    $form = '
            <form action="../ejercicio10/subirImg.php" method="post" enctype="multipart/form-data">
